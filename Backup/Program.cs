...
namespace Mip2011
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Ordre ord2 = new Ordre(ter1, 1);
            Ordre ord3 = new Ordre(fl1, 2);
            //Indkøbskurv2.GetIndkøbskurv().TilføjOrdre(ord);
            Indkøbskurv.GetIndkøbskurv().TilføjOrdre(ord2);
            Indkøbskurv.GetIndkøbskurv().TilføjOrdre(ord3);
            ...
            while (end == false)
            {
                ...
                switch (i)
                {
                    case 1:
                        ...
                        Console.WriteLine(ProduktKartotek.GetProduktKartotek().FindeProduktMedProduktKodeX(a));
                        Console.WriteLine("");
                        break;
